...
public class StudentView extends JPanel implements StudentRefInterface {
    ...
    private static final String STUDENT_STUDYID = "StudyID ";
    ...
    private static final int STUDYID_COL_WIDTH = 50;
    private static final int EMAIL_COL_WIDTH = 50;


    private StudentController controller;
    private JLabel firstNameLabel, lastNameLabel, courseLabel, addressLabel, studyIDLabel, emailLabel;
    private JTextField firstName, lastName, course, address, studyID, email;
    ...
    public void createGui() {
        ...
        studyIDLabel = new JLabel(STUDENT_STUDYID);
        ...
        studyID = new JTextField(STUDYID_COL_WIDTH);
    ...
    public void refresh(String newFirstName, String newLastName,
            String newTitle, String newOrganization, String newstudyID, String newemail) {
        firstName.setText(newFirstName);
        lastName.setText(newLastName);
        course.setText(newTitle);
        address.setText(newOrganization);
        studyID.setText(newstudyID);
